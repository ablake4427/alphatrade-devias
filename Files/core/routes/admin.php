...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageFutureTradeController')->name('future.trade.')->prefix('future/trade')->group(function(){
        ...
        Route::get('history', 'tradeHistory')->name('history');

        Route::get('config/pairs', 'pairs')->name('config.pairs');
        Route::get('config/create', 'create')->name('config.create');
        Route::get('config/edit/{id}', 'edit')->name('config.edit');
        Route::post('config/save/{id?}', 'save')->name('config.save');
        Route::get('config/status/{id}', 'changeStatus')->name('config.status');
    });

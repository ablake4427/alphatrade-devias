                                    ...
                                    @if ($user->email)
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <small class="text--danger usernameExist mt-2"></small>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form--control" name="firstname" value="{{ old('firstname') }}" required placeholder="@lang('Your First Name')">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form--label">@lang('Last Name')</label>
                                                <input type="text" class="form--control" name="lastname" value="{{ old('lastname') }}" required placeholder="@lang('Your Last Name')">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
